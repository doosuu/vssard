...
pub mod datapoint_table;
pub mod datapoint_type;
pub mod metadata_table;
pub mod metadata_type;
pub mod register_datapoint_reducer;
pub mod set_datapoint_target_value_reducer;
pub mod set_datapoint_value_reducer;
pub mod variant_type_type;

pub use datapoint_table::*;
pub use datapoint_type::Datapoint;
pub use metadata_table::*;
pub use metadata_type::Metadata;
pub use register_datapoint_reducer::{
    RegisterDatapointCallbackId, register_datapoint, set_flags_for_register_datapoint,
};
pub use set_datapoint_target_value_reducer::{
    SetDatapointTargetValueCallbackId, set_datapoint_target_value,
    set_flags_for_set_datapoint_target_value,
};
pub use set_datapoint_value_reducer::{
    SetDatapointValueCallbackId, set_datapoint_value, set_flags_for_set_datapoint_value,
};
pub use variant_type_type::VariantType;
...
pub enum Reducer {
    RegisterDatapoint { path: String },
    SetDatapointTargetValue { id: u32, target_value: VariantType },
    SetDatapointValue { id: u32, value: VariantType },
}
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::RegisterDatapoint { .. } => "register_datapoint",
            Reducer::SetDatapointTargetValue { .. } => "set_datapoint_target_value",
            Reducer::SetDatapointValue { .. } => "set_datapoint_value",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "register_datapoint" => Ok(__sdk::parse_reducer_args::<
                register_datapoint_reducer::RegisterDatapointArgs,
            >("register_datapoint", &value.args)?
            .into()),
            "set_datapoint_target_value" => {
                Ok(__sdk::parse_reducer_args::<
                    set_datapoint_target_value_reducer::SetDatapointTargetValueArgs,
                >("set_datapoint_target_value", &value.args)?
                .into())
            }
            "set_datapoint_value" => Ok(__sdk::parse_reducer_args::<
                set_datapoint_value_reducer::SetDatapointValueArgs,
            >("set_datapoint_value", &value.args)?
            .into()),
            unknown => {
                Err(
...
#[doc(hidden)]
pub struct DbUpdate {
    datapoint: __sdk::TableUpdate<Datapoint>,
    metadata: __sdk::TableUpdate<Metadata>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "datapoint" => {
                    db_update.datapoint = datapoint_table::parse_table_update(table_update)?
                }
                "metadata" => {
                    db_update.metadata = metadata_table::parse_table_update(table_update)?
                }
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.datapoint = cache
            .apply_diff_to_table::<Datapoint>("datapoint", &self.datapoint)
            .with_updates_by_pk(|row| &row.id);
        diff.metadata = cache
            .apply_diff_to_table::<Metadata>("metadata", &self.metadata)
...
pub struct AppliedDiff<'r> {
    datapoint: __sdk::TableAppliedDiff<'r, Datapoint>,
    metadata: __sdk::TableAppliedDiff<'r, Metadata>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Datapoint>("datapoint", &self.datapoint, event);
        callbacks.invoke_table_row_callbacks::<Metadata>("metadata", &self.metadata, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        datapoint_table::register_table(client_cache);
        metadata_table::register_table(client_cache);
    }
}
